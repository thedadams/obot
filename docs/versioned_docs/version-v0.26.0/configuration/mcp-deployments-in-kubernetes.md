...
- Image: the default value is `ghcr.io/obot-platform/mcp-images/stdio-wrapper:v0.26.1` and it can be changed by setting the Helm value `.config.OBOT_SERVER_MCPBASE_IMAGE`.
