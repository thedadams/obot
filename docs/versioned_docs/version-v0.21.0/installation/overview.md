...
3. [Configure authentication](../configuration/auth-providers.md)
4. [Set up model providers](../configuration/model-providers.md)
5. Review the [server configuration options](../configuration/server-configuration.md)
