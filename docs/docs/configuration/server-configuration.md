...
| `OBOT_SERVER_DEFAULT_VMCPCATALOG_PATHS` | Comma-delimited Git URLs or local paths used to seed the default vMCP catalog only when it does not already exist. | - |
