...
type Config struct {
	...
	MDMAssetSource                       string `usage:"The source for MDM assets (a local directory, a tar archive path, or an HTTP(S) tarball URL)" default:"https://github.com/obot-platform/obot-sentry/releases/download/v0.1.3/mdm-assets.tar.gz" env:"OBOT_SERVER_MDM_ASSET_SOURCE"`
